...
#define SCRIBE_DATA_STRING_ALWAYS	0x00004000
#define SCRIBE_DATA_ALWAYS		0x00008000
#define SCRIBE_RES_ALWAYS		0x00010000
#define SCRIBE_FENCE_ALWAYS		0x00020000
#define SCRIBE_REGS			0x00040000
